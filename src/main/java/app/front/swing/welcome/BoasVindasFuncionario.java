 ...
 */
public class BoasVindasFuncionario extends javax.swing.JPanel implements BoasVindasModel {

    private LeitorPlanoUsuario leitor;
    
    private String plano;
    
    public BoasVindasFuncionario(String usuario) {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(BoasVindasFuncionario.class.getName()).log(Level.SEVERE, null, ex);
        }
